import { Boton, Campo, Plegable } from './ui'
    ...
    <div className="inspector">
      ...
      {elemento ? (
        <section className="inspector__grupo">
          ...
          {/* Las coordenadas se consultan de vez en cuando; el color, a cada rato.
              Por eso van plegadas y debajo de lo que se usa de verdad. */}
          <Plegable titulo="Posición, tamaño y orden">
          <div className="rejilla rejilla--2">
            <Campo etiqueta="X">
              {(props) => (
                <input
      ...
      {/* Propiedades de la pieza completa: se consultan al empezar y al cerrar,
          no mientras se dibuja, así que no compiten con el elemento activo. */}
      <Plegable titulo="Fondo del banner" abierto={!elemento}>
      <section className="inspector__grupo">
      ...
      <Plegable titulo="Enlace del banner">
      <section className="inspector__grupo">
